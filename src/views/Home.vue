            ...
            <div class="grid grid-rows-4 grid-flow-col gap-6">
                <div class="col">
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                        <div class="py-3 px-6 mb-0 bg-gray-200 border-gray-300 text-gray-900">
                            <h3 class="mb-3">Form Donasi</h3>
                        </div>
                        <div class="flex-auto p-6">
                            <list-donatur @selectedDonatur="selectedDonatur" />
                            <list-bantuan @selectedBantuan="selectedBantuan" />
                            <div class="mb-4">
                                <label for="">Jumlah Donasi (Rp)</label>
                                <input type="number" v-model="jumlah" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border-gray-200 rounded">
                            </div>
                                <div class="mb-4">
